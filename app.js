...
const customText = urlParams.get('text') || 'FOLLOW Instagram @hafizhmaulana_y'
const customSpeed = urlParams.get('speed') / 100000 || 2000 / 100000
const space = '                        '
...
_anim()
console.log('%c Based on codepen by Tiffany Rayside ', 'background: #222; color: #bada55')
